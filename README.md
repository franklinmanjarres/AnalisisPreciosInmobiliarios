...
![Comparación de MAE: LinearRegression vs HuberRegressor](assets/mae_comparison.png)
...
3. **Entidades Financieras (Bancos):** Necesitan calcular con total precisión el valor de las garantías que respaldan los Vernon hipotecarios para mitigar el riesgo de impago.
